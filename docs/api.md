...
- cli: `apps/cli/src/api/client.ts`
...
6. Use the typed client from the webapp or CLI
...
- typed payloads
- typed responses
- fewer contract mismatches between frontend, CLI, and backend
...
- `apps/cli/src/api/client.ts` decides the CLI base URL
